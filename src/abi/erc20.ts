...
export type Approve0Function = [_spender: string, _value: ethers.BigNumber] & {
    _spender: string;
...
export type TransferFrom0Function = [
    ...
    _to: string,
    _value: ethers.BigNumber
] & { _from: string; _to: string; _value: ethers.BigNumber };

export type Transfer0Function = [_to: string, _value: ethers.BigNumber] & {
    _to: string;
    _value: ethers.BigNumber;
};
