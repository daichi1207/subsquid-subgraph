...
export type Mint0Event = [
    sender: string,
    amount0: ethers.BigNumber,
    amount1: ethers.BigNumber
] & { sender: string; amount0: ethers.BigNumber; amount1: ethers.BigNumber };

export type Swap0Event = [
    sender: string,
...
export type Sync0Event = [
    reserve0: ethers.BigNumber,
    reserve1: ethers.BigNumber
] & { reserve0: ethers.BigNumber; reserve1: ethers.BigNumber };

export type Transfer0Event = [
    from: string,
    to: string,
    value: ethers.BigNumber
] & { from: string; to: string; value: ethers.BigNumber };
...
export type Approve0Function = [spender: string, value: ethers.BigNumber] & {
    spender: string;
    value: ethers.BigNumber;
};
...
export type Initialize0Function = [_token0: string, _token1: string] & {
    _token0: string;
    _token1: string;
};
...
export type Transfer0Function = [to: string, value: ethers.BigNumber] & {
    to: string;
    value: ethers.BigNumber;
};

export type TransferFrom0Function = [
    from: string,
    to: string,
    value: ethers.BigNumber
] & { from: string; to: string; value: ethers.BigNumber };
...
export class Contract {
    ...
    async allowance(arg0: string, arg1: string): Promise<ethers.BigNumber> {
        return this.call('allowance', [arg0, arg1]);
    }

    async balanceOf(arg0: string): Promise<ethers.BigNumber> {
        return this.call('balanceOf', [arg0]);
    }
